...
namespace Bolnica.Manager
{
    public class NoValidation
    {
        ...
        public NoValidation(string medicamentID, string medicamentName, MedicamentsType medicamentType, string substances, MedicamentCategoria medicamentsCategoria)
        {
